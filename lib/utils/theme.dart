/*
 * *
 *  * Created by Rafsan Ahmad on 11/5/21, 8:55 PM
...
ThemeData buildReplyLightTheme(BuildContext context) {
  ...
  return base.copyWith(
    ...
    textTheme: buildReplyLightTextTheme(base.textTheme),
...
ThemeData buildReplyDarkTheme(BuildContext context) {
  ...
  return base.copyWith(
    ...
    textTheme: buildReplyDarkTextTheme(base.textTheme),
...
TextTheme buildReplyLightTextTheme(TextTheme base) {
  return base.copyWith(
...
TextTheme buildReplyDarkTextTheme(TextTheme base) {
  return base.copyWith(
    headline4: GoogleFonts.workSans(
      fontWeight: FontWeight.w600,
      fontSize: 34,
